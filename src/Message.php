...
class Message extends BaseMessage
{
     ...
     *
     * Example: ['May', '2022', 'monthly', 'reports']
     *
     * @var array
     */
    public $categories;
    ...
    /**
     * @var integer Unix timestamp of when you want the email to send. Example: `1659629318`
     */
    public $sendAt;
    ...
    /**
     * @var string The SendGrid IP Pool to send from. Example: `"33
     * "`
     */
    public $ipPoolName;
    ...
    public function buildMessage()
    {
        if ( isset($this->from, $this->subject) && ( (isset($this->textBody) && !empty($this->textBody)) || (isset($this->htmlBody) && !empty($this->htmlBody)) ) )
        {
            ...
            if ( isset($this->replyTo) ) {
                $this->getSendGridMail()->setReplyTo($this->replyTo);
            }
